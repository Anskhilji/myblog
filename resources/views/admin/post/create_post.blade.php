                    ...
                    <form action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
                        ...
                        @else
                            <div class="row add-schema">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="#schema" class="schema_count">Schema</label>
                                        <div class="float-right m-2 test">
                                            <span>Add More</span>
                                            <button type="button" class="btn btn-success" id="add-more"><i class="ti-plus"></i></button>
                                        </div>
                        ...
                        @endif
                            ...
                            {{--Green Text--}}
                        <?php
                            $green_heading = old('green_heading');
                            $green_body = old('green_body');
                        ?>
                        @if(!empty($green_heading) and count($green_heading) > 0)
                           <?php
//                            $count = count($green_heading) ;
//                            for ($i = 0; $i < $count; $i++){
//                                $array[] = [$green_heading[$i],$green_body[$i]];
//                            }
//                            echo "<pre>";
//                            print_r($array);
//                            die();
...
//                            dd($green_arr);
                        ...
                        {{--Faqs--}}
                        <?php
                        $faqs_question = old('faqs_question');
                        $faqs_answer = old('faqs_answer');
                        ?>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                    <div class="form-group col-lg-12 col-md-12">
                                        <div class="card">
                                            <div class="card-header card bg-secondary text-white d-flex">{{--<span class="text-danger">*</span>--}}
                                                <b> Cover Image <small> 370 x 215</small></b>
                                            </div>
                                            <div class="card-body">
                                                <div class="uc-image">
                                                    <span class="clear-image-x">x</span>
                                                    <input type="hidden" name="cover-image" value="{{old("cover-image")}}">
                                                    <div id='cover' class="image_display"><img src="{{old("cover-image")}}"></div>
                                ...
                                <div class="form-group col-lg-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="uc-image">
                                                <span class="clear-image-x">x</span>
                                                <input type="hidden" name="og-image" value="{{old("og-image")}}">
                                                <div id='og_image' class="image_display">
                                                    <img src="{{old("og-image")}}">
                                                </div>
                                                <div style="margin-top:10px;">
