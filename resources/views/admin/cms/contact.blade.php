        ...
        <div class="pcoded-inner-content">
            <div class="main-body">
                <div class="page-wrapper">
                    <form action="{{ route('store.contact.schema') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-input" name="meta_title" value="{{ old('meta_title',$contact->meta_title) }}"  id="metatitle" placeholder="Meta Title">
                                    <span class="input-group-addon meta-title" >{{ strlen($contact->meta_title) }}</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control meta-input" name="meta_description" id="schema" rows="5">{!! old('meta_description', $contact->meta_description) !!} </textarea>
                                    <span class="input-group-addon meta-desc" >{{ strlen($contact->meta_description) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-tags" data-role="tagsinput" name="meta_tags" value="{{ old('meta_tags', $contact->meta_tags) }}" id="metatags" placeholder="Meta Title">
                                </div>
                            </div>
                        </div>

                        <?php
                        $schema_old = old('home_schema') ? old('home_schema') : json_decode($contact->home_schema);
                        ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="uc-image">
                                        ...
                                        <input type="hidden" name="og-image" value="{{old("og-image",$contact->og_image)}}">
                                        <div id='og_image' class="image_display">
                                            <img src="{{old("og-image",$contact->og_image)}}">
                                        </div>
