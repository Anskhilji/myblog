                    ...
                    <form action="{{ route('store.privacy.policy') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-input" name="meta_title" value="{{ old('meta_title',$privacy_policy->meta_title) }}"  id="metatitle" placeholder="Meta Title">
                                    <span class="input-group-addon meta-title" >{{ strlen($privacy_policy->meta_title) }}</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control meta-input" name="meta_description" id="schema" rows="5">{!! old('meta_description', $privacy_policy->meta_description) !!} </textarea>
                                    <span class="input-group-addon meta-desc" >{{ strlen($privacy_policy->meta_description) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-tags" data-role="tagsinput" name="meta_tags" value="{{ old('meta_tags', $privacy_policy->meta_tags) }}" id="metatags" placeholder="Meta Title">
                                </div>
                            </div>
                        </div>

                        <?php
                        $schema_old = old('home_schema') ? old('home_schema') : json_decode($privacy_policy->home_schema);
                        ?>
                ...
                <div class="row ml-3 mr-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <span class="text-danger">@error('privacy_policy_detail'){{$message}}@enderror</span>
                            <textarea class="form-control oneditor" name="privacy_policy_detail" id="oneditor" rows="5" placeholder="Post details...">{!! old('post_detail', $privacy_policy->detail) !!}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="uc-image">
                                        ...
                                        <input type="hidden" name="og-image" value="{{old("og-image",$privacy_policy->og_image)}}">
                                        <div id='og_image' class="image_display">
                                            <img src="{{old("og-image",$privacy_policy->og_image)}}">
                                        </div>
