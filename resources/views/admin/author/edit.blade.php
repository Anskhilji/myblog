        ...
        <div class="pcoded-inner-content">
            <div class="main-body">
                <div class="page-wrapper">
                    <form action="{{ route('update.author',$author->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <label for="#posttitle">Author Name<span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" name="name" value="{{old('name', $author->name)}}" class="form-control post-for-slug" id="posttitle" placeholder="Author Name">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="slug" value="{{ old('slug', $author->slug) }}" class="form-control post-slug" id="postslug" placeholder="Slug">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-input" name="meta_title" value="{{ old('meta_title', $author->meta_title) }}"  id="metatitle" placeholder="Meta Title">
                                    <span class="input-group-addon meta-title" >{{ strlen($author->meta_title) }}</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control meta-input" name="meta_description" id="schema" rows="5">{!! old('meta_description', $author->meta_description) !!} </textarea>
                                    <span class="input-group-addon meta-desc" >{{ strlen($author->meta_description) }}</span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control meta-tags" data-role="tagsinput" name="meta_tags" value="{{ old('meta_tags',$author->meta_tags) }}" id="metatags" placeholder="Meta Title">
                                </div>
                        ...
                        <?php
                        $schema_old = old('author_schema') ? old('author_schema') : json_decode($author->author_schema);
                        ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control oneditor" name="author_detail" id="oneditor" rows="5">{!! old('author_detail', $author->detail) !!}</textarea>
                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="uc-image">
                                                ...
                                                <input type="hidden" name="cover_image" value="{{old("cover_image", $author->cover_image)}}">
                                                <div id='cover' class="image_display"><img src="{{old("cover_image",$author->cover_image)}}"></div>
                                ...
                                <div class="form-group col-lg-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="uc-image">
                                                <span class="clear-image-x">x</span>
                                                <input type="hidden" name="og_image" value="{{old("og_image", $author->og_image)}}">
                                                <div id='og_image' class="image_display">
                                                    <img src="{{old("og_image",$author->og_image)}}">
                                                </div>
                                                <div style="margin-top:10px;">
